        ...
        $.fn.html5lightbox = function (options) {
            ...
            inst.options = $.extend(
                {
                    ...
                    fadespeed: 1000,
                    jsfolder: jsFolder,
                    skinsfoldername: "https://cdn.shopify.com/s/files/1/0003/2361/6774/files/",
            ...
            inst.readData = function () {
                inst.each(function () {
                    ...
                    inst.elemArray.push(
                        new Array(fileType, $this.attr("href"), title, $this.data("group"), $this.data("width"), $this.data("height"), $this.data("webm"), $this.data("ogg"), $this.data("thumbnail"), $this.data("description"))
                    );
                });
            };
            ...
            inst.showYoutubeVimeo = function (elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function () {
                    ...
                    $("#html5lightbox-video").html(
                        "<iframe style='margin:0;padding:0;border:0;' id='html5boxiframevideo' width='100%' height='100%' src='" + href + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>"
                    );
                    inst.$elem.show();
                    inst.showData();
            ...
            inst.showWeb = function (elem) {
                ...
                inst.resizeLightbox(dataW, dataH, true, function () {
                    ...
                    $("#html5lightbox-web").html(
                        "<iframe style='margin:0;padding:0;border:0;' id='html5lightbox-web-iframe' width='100%' height='100%' src='" + elem[ELEM_HREF] + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>"
                    );
                    inst.$elem.show();
                    inst.showData();
